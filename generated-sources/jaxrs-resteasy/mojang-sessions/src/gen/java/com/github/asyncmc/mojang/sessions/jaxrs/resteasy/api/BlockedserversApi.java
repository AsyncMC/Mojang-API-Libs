...
import com.github.asyncmc.mojang.sessions.jaxrs.resteasy.api.BlockedserversApiService;
...
public class BlockedserversApi  {
    ...
    @Inject BlockedserversApiService service;
    ...
    throws NotFoundException {
        return service.getBlockedServerHashes(securityContext);
    }
}
