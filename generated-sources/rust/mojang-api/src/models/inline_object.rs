...
impl InlineObject {
  pub fn new(file: ::models::File) -> InlineObject {
    InlineObject {
      model: None,
      file: file
    }
  ...
  pub fn with_model(mut self, model: ::models::SkinModel) -> InlineObject {
    self.model = Some(model);
    self
  }
  ...
  pub fn with_file(mut self, file: ::models::File) -> InlineObject {
    self.file = file;
    self
  }
