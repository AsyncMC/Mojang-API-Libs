...
public function registerBundles()
{
    $bundles = array(
        // ...
        new com.github.asyncmc.mojang.status.php.symfony.server\OpenAPIServerBundle(),
        // ...
    );
}
```
...
------------ | ------------- | ------------- | -------------
*DefaultApiInterface* | [**checkStatuses**](Resources\docs\Api/DefaultApiInterface.md#checkstatuses) | **GET** /check | Checks the Mojang service statuses


## Documentation For Models

 - [ApiStatus](Resources\docs\Model/ApiStatus.md)
