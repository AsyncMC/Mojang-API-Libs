...
import com.github.asyncmc.mojang.sessions.jaxrs.spec.model.PlayerTexture;
...
public class PlayerProfileTexturePropertyValue   {
  ...
  private @Valid String profileName;
  private @Valid Boolean signatureRequired = false;
  private @Valid PlayerTexture textures = null;
