...
import com.github.asyncmc.mojang.api.android.server.auth.Authentication;
import com.github.asyncmc.mojang.api.android.server.auth.ApiKeyAuth;
import com.github.asyncmc.mojang.api.android.server.auth.HttpBasicAuth;
import com.github.asyncmc.mojang.api.android.server.request.GetRequest;
import com.github.asyncmc.mojang.api.android.server.request.PostRequest;
import com.github.asyncmc.mojang.api.android.server.request.PutRequest;
import com.github.asyncmc.mojang.api.android.server.request.DeleteRequest;
import com.github.asyncmc.mojang.api.android.server.request.PatchRequest;
...
public class ApiInvoker {
  ...
  */
  ...
  public static void initializeInstance(Cache cache, Network network, int threadPoolSize, ResponseDelivery delivery, int connectionTimeout) {
    ...
    INSTANCE.authentications.put("MojangStatisticsToken", new HttpBasicAuth());
    INSTANCE.authentications.put("PlayerAccessToken", new HttpBasicAuth());
