...
package com.github.asyncmc.mojang.status.android.server;
...
import com.github.asyncmc.mojang.status.android.server.auth.Authentication;
import com.github.asyncmc.mojang.status.android.server.auth.ApiKeyAuth;
import com.github.asyncmc.mojang.status.android.server.auth.HttpBasicAuth;
import com.github.asyncmc.mojang.status.android.server.request.GetRequest;
import com.github.asyncmc.mojang.status.android.server.request.PostRequest;
import com.github.asyncmc.mojang.status.android.server.request.PutRequest;
import com.github.asyncmc.mojang.status.android.server.request.DeleteRequest;
import com.github.asyncmc.mojang.status.android.server.request.PatchRequest;
