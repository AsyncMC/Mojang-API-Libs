/**
 * @fileoverview AUTOMATICALLY GENERATED service for API.Client.BansApi.
 ...
 */
goog.provide('API.Client.BansApi');
 ...
 * @struct
 */
API.Client.BansApi = function($http, $httpParamSerializer, $injector) {
  /** @private {!string} */
  this.basePath_ = $injector.has('BansApiBasePath') ?
                   /** @type {!string} */ ($injector.get('BansApiBasePath')) :
                   'https://sessionserver.mojang.com';

  /** @private {!Object<string, string>} */
  this.defaultHeaders_ = $injector.has('BansApiDefaultHeaders') ?
                   /** @type {!Object<string, string>} */ (
                       $injector.get('BansApiDefaultHeaders')) :
                   {};
...
API.Client.BansApi.$inject = ['$http', '$httpParamSerializer', '$injector'];
 ...
 */
API.Client.BansApi.prototype.getBlockedServerHashes = function(opt_extraHttpRequestParams) {
  /** @const {string} */
  var path = this.basePath_ + '/blockedservers';
