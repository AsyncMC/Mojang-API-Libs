...
OAIRefreshRequest*
OAIRefreshRequest::fromJson(QString json) {
...
void
OAIRefreshRequest::fromJsonObject(QJsonObject pJson) {
...
QJsonObject
OAIRefreshRequest::asJsonObject() {
    QJsonObject obj;
...
QString*
OAIRefreshRequest::getAccessToken() {
    return access_token;
}
void
OAIRefreshRequest::setAccessToken(QString* access_token) {
    this->access_token = access_token;
    this->m_access_token_isSet = true;
}

QString*
OAIRefreshRequest::getClientToken() {
    return client_token;
}
void
OAIRefreshRequest::setClientToken(QString* client_token) {
