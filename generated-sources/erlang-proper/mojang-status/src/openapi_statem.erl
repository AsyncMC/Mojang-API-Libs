...
check_statuses() ->
  openapi_api:check_statuses().

check_statuses_args(S) ->
  Args = [],
  case erlang:function_exported(?MODULE, 'check_statuses_args_custom', 2) of
    true -> ?MODULE:check_statuses_args_custom(S, Args);
    false -> Args
  end.
