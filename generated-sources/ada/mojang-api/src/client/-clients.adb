...
package body .Clients is
   ...
   procedure Get_Orders_Statistics
      (Client : in out Client_Type;
       ...
       Result : out .Models.OrderStatisticsResponse_Type) is
   ...
   begin
      ...
      .Models.Serialize (Req.Stream, "", Order_Statistics_Request_Type);
   ...
   procedure Find_Unique_Ids_By_Name
      (Client : in out Client_Type;
       ...
       Result : out .Models.CurrentPlayerIDs_Type_Vectors.Vector) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
      Reply : Swagger.Value_Type;
   begin
      Client.Set_Accept ((1 => Swagger.Clients.APPLICATION_JSON));
      Client.Initialize (Req, (1 => Swagger.Clients.APPLICATION_JSON));
      .Models.Serialize (Req.Stream, "", String);
   ...
   procedure Get_Name_History
      (Client : in out Client_Type;
       ...
       Result : out .Models.NameChange_Type_Vectors.Vector) is
      URI   : Swagger.Clients.URI_Type;
      Reply : Swagger.Value_Type;
   begin
      Client.Set_Accept ((1 => Swagger.Clients.APPLICATION_JSON));
   ...
   procedure Get_Unique_Id_By_Name
      (Client : in out Client_Type;
       ...
       Result : out .Models.CurrentPlayerIDs_Type) is
      URI   : Swagger.Clients.URI_Type;
      Reply : Swagger.Value_Type;
   begin
      Client.Set_Accept ((1 => Swagger.Clients.APPLICATION_JSON));
   ...
   procedure List_Pending_Security_Questions
      (Client : in out Client_Type;
       Result : out .Models.SecurityChallenge_Type_Vectors.Vector) is
      URI   : Swagger.Clients.URI_Type;
      Reply : Swagger.Value_Type;
   begin
      Client.Set_Accept ((1 => Swagger.Clients.APPLICATION_JSON));
   ...
   procedure Send_Security_Question_Answers
      (Client : in out Client_Type;
       Security_Answer : in .Models.SecurityAnswer_Type_Vectors.Vector) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
   begin
      Client.Set_Accept ((1 => Swagger.Clients.APPLICATION_JSON));
      Client.Initialize (Req, (1 => Swagger.Clients.APPLICATION_JSON));
      .Models.Serialize (Req.Stream, "", Security_Answer);
   ...
   procedure Change_Player_Skin
      (Client : in out Client_Type;
       ...
       Model : in .Models..Models.SkinModel_Type) is
      URI   : Swagger.Clients.URI_Type;
      Req   : Swagger.Clients.Request_Type;
   begin
      Client.Set_Accept ((1 => Swagger.Clients.APPLICATION_JSON));
