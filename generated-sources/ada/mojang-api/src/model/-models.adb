...
package body .Models is
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Inline_object_1_Type) is
   begin
      Into.Start_Entity (Name);
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Inline_object_1_Type_Vectors.Vector) is
   begin
      Into.Start_Array (Name);
      for Item of Value loop
         Serialize (Into, "", Item);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Inline_object_1_Type) is
      Object : Swagger.Value_Type;
   begin
      Swagger.Streams.Deserialize (From, Name, Object);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Inline_object_1_Type_Vectors.Vector) is
      List : Swagger.Value_Array_Type;
      Item : Inline_object_1_Type;
   begin
      Value.Clear;
      Swagger.Streams.Deserialize (From, Name, List);
      for Data of List loop
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Inline_object_Type) is
   begin
      Into.Start_Entity (Name);
      Serialize (Into, "model", Value.Model);
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Inline_object_Type_Vectors.Vector) is
   begin
      Into.Start_Array (Name);
      for Item of Value loop
         Serialize (Into, "", Item);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Inline_object_Type) is
      Object : Swagger.Value_Type;
   begin
      Swagger.Streams.Deserialize (From, Name, Object);
      Deserialize (Object, "model", Value.Model);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Inline_object_Type_Vectors.Vector) is
      List : Swagger.Value_Array_Type;
      Item : Inline_object_Type;
   begin
      Value.Clear;
      Swagger.Streams.Deserialize (From, Name, List);
      for Data of List loop
