...
module Data.ReducedUserData exposing (ReducedUserData(..), decoder, encoder)
...
type alias ReducedUserData =
    { id : Maybe (String)
    , properties : Maybe ((List GameProfileProperty))
    }


decoder : Decoder ReducedUserData
decoder =
    Decode.succeed ReducedUserData
...
encoder : ReducedUserData -> Encode.Value
encoder model =
    Encode.object
