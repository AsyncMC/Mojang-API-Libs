...
public class GameProfile   {
  ...
  public GameProfile (String agent, String id, String name, String userId, Long createdAt, Boolean legacyProfile, Boolean suspended, Boolean paid, Boolean migrated, Boolean legacy) {
    this.agent = agent;
    this.id = id;
    this.name = name;
    this.userId = userId;
