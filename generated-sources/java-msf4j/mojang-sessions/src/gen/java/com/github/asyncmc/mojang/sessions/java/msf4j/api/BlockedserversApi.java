...
import com.github.asyncmc.mojang.sessions.java.msf4j.api.factories.BlockedserversApiServiceFactory;
...
public class BlockedserversApi  {
   private final BlockedserversApiService delegate = BlockedserversApiServiceFactory.getBlockedserversApi();
    ...
    throws NotFoundException {
        return delegate.getBlockedServerHashes();
    }
}
