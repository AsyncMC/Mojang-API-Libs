...
export const MiscellaneousApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getOrdersStatistics(orderStatisticsRequest: OrderStatisticsRequest, options: any = {}): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(orderStatisticsRequest || {}) : (orderStatisticsRequest || "");
...
export const MiscellaneousApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getOrdersStatistics(orderStatisticsRequest: OrderStatisticsRequest, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<OrderStatisticsResponse> {
 ...
 * @export
 */
export const MiscellaneousApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Get statistics on the sales of Minecraft.
        ...
        getOrdersStatistics(orderStatisticsRequest: OrderStatisticsRequest, options?: any) {
            return MiscellaneousApiFp(configuration).getOrdersStatistics(orderStatisticsRequest, options)(fetch, basePath);
        },
    };
};
...
export class MiscellaneousApi extends BaseAPI {
    ...
    public getOrdersStatistics(orderStatisticsRequest: OrderStatisticsRequest, options?: any) {
        return MiscellaneousApiFp(this.configuration).getOrdersStatistics(orderStatisticsRequest, options)(this.fetch, this.basePath);
    }
...
export const NameHistoryApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        findUniqueIdsByName(requestBody: Array<string>, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        getNameHistory(strippedUuid: string, options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        getUniqueIdByName(username: string, at?: number, options: any = {}): FetchArgs {
...
export const NameHistoryApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        findUniqueIdsByName(requestBody: Array<string>, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<CurrentPlayerIDs>> {
         ...
         * @throws {RequiredError}
         */
        getNameHistory(strippedUuid: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<NameChange>> {
         ...
         * @throws {RequiredError}
         */
        getUniqueIdByName(username: string, at?: number, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<CurrentPlayerIDs> {
 ...
 * @export
 */
export const NameHistoryApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * Find the current players name, UUID, demo status and migration flag by the current players name. The \"at\" parameter is not supported. Players not found are not returned. If no players are found, an empty array is returned.
         * @summary Find the current UUID of multiple players at once
        ...
        findUniqueIdsByName(requestBody: Array<string>, options?: any) {
            return NameHistoryApiFp(configuration).findUniqueIdsByName(requestBody, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Gets the full player's name history
        ...
        getNameHistory(strippedUuid: string, options?: any) {
            return NameHistoryApiFp(configuration).getNameHistory(strippedUuid, options)(fetch, basePath);
        },
        /**
         * Find the current player name, UUID, demo status and migration flag by the current player name or at a given time.
         * @summary Find the UUID by name
        ...
        getUniqueIdByName(username: string, at?: number, options?: any) {
            return NameHistoryApiFp(configuration).getUniqueIdByName(username, at, options)(fetch, basePath);
        },
    };
};
...
export class NameHistoryApi extends BaseAPI {
    ...
    public findUniqueIdsByName(requestBody: Array<string>, options?: any) {
        return NameHistoryApiFp(this.configuration).findUniqueIdsByName(requestBody, options)(this.fetch, this.basePath);
    }
    ...
    public getNameHistory(strippedUuid: string, options?: any) {
        return NameHistoryApiFp(this.configuration).getNameHistory(strippedUuid, options)(this.fetch, this.basePath);
    }
    ...
    public getUniqueIdByName(username: string, at?: number, options?: any) {
        return NameHistoryApiFp(this.configuration).getUniqueIdByName(username, at, options)(this.fetch, this.basePath);
    }
...
export const SecurityQuestionAnswerApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        checkSecurityStatus(options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        listPendingSecurityQuestions(options: any = {}): FetchArgs {
         ...
         * @throws {RequiredError}
         */
        sendSecurityQuestionAnswers(securityAnswer: Array<SecurityAnswer>, options: any = {}): FetchArgs {
            ...
            localVarRequestOptions.body =  needsSerialization ? JSON.stringify(securityAnswer || {}) : (securityAnswer || "");
...
export const SecurityQuestionAnswerApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        checkSecurityStatus(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
         ...
         * @throws {RequiredError}
         */
        listPendingSecurityQuestions(options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Array<SecurityChallenge>> {
         ...
         * @throws {RequiredError}
         */
        sendSecurityQuestionAnswers(securityAnswer: Array<SecurityAnswer>, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
 ...
 * @export
 */
export const SecurityQuestionAnswerApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * 
         * @summary Check if security questions are needed
        ...
        checkSecurityStatus(options?: any) {
            return SecurityQuestionAnswerApiFp(configuration).checkSecurityStatus(options)(fetch, basePath);
        },
        /**
         * 
         * @summary Get list of questions
        ...
        listPendingSecurityQuestions(options?: any) {
            return SecurityQuestionAnswerApiFp(configuration).listPendingSecurityQuestions(options)(fetch, basePath);
        },
        /**
         * 
         * @summary Send back the answers
        ...
        sendSecurityQuestionAnswers(securityAnswer: Array<SecurityAnswer>, options?: any) {
            return SecurityQuestionAnswerApiFp(configuration).sendSecurityQuestionAnswers(securityAnswer, options)(fetch, basePath);
        },
    };
};
...
export class SecurityQuestionAnswerApi extends BaseAPI {
    ...
    public checkSecurityStatus(options?: any) {
        return SecurityQuestionAnswerApiFp(this.configuration).checkSecurityStatus(options)(this.fetch, this.basePath);
    }
    ...
    public listPendingSecurityQuestions(options?: any) {
        return SecurityQuestionAnswerApiFp(this.configuration).listPendingSecurityQuestions(options)(this.fetch, this.basePath);
    }
    ...
    public sendSecurityQuestionAnswers(securityAnswer: Array<SecurityAnswer>, options?: any) {
        return SecurityQuestionAnswerApiFp(this.configuration).sendSecurityQuestionAnswers(securityAnswer, options)(this.fetch, this.basePath);
    }
...
export const SkinOperationsApiFetchParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        changePlayerSkin(strippedUuid: string, url: string, model?: SkinModel, options: any = {}): FetchArgs {
            // verify required parameter 'strippedUuid' is not null or undefined
            if (strippedUuid === null || strippedUuid === undefined) {
         ...
         * @throws {RequiredError}
         */
        resetPlayerSkin(strippedUuid: string, options: any = {}): FetchArgs {
            // verify required parameter 'strippedUuid' is not null or undefined
            if (strippedUuid === null || strippedUuid === undefined) {
         ...
         * @throws {RequiredError}
         */
        uploadPlayerSkin(strippedUuid: string, file: any, model?: SkinModel, options: any = {}): FetchArgs {
            // verify required parameter 'strippedUuid' is not null or undefined
            if (strippedUuid === null || strippedUuid === undefined) {
...
export const SkinOperationsApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        changePlayerSkin(strippedUuid: string, url: string, model?: SkinModel, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
         ...
         * @throws {RequiredError}
         */
        resetPlayerSkin(strippedUuid: string, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
         ...
         * @throws {RequiredError}
         */
        uploadPlayerSkin(strippedUuid: string, file: any, model?: SkinModel, options?: any): (fetch?: FetchAPI, basePath?: string) => Promise<Response> {
 ...
 * @export
 */
export const SkinOperationsApiFactory = function (configuration?: Configuration, fetch?: FetchAPI, basePath?: string) {
    return {
        /**
         * This will set the skin for the selected profile, but Mojang's servers will fetch the skin from a URL. This will also work for legacy accounts.
         * @summary Changes the player skin by URL
        ...
        changePlayerSkin(strippedUuid: string, url: string, model?: SkinModel, options?: any) {
            return SkinOperationsApiFp(configuration).changePlayerSkin(strippedUuid, url, model, options)(fetch, basePath);
        },
        /**
         * 
         * @summary Resets the player skin to default
        ...
        resetPlayerSkin(strippedUuid: string, options?: any) {
            return SkinOperationsApiFp(configuration).resetPlayerSkin(strippedUuid, options)(fetch, basePath);
        },
        /**
         * This uploads a skin to Mojang's servers. It also sets the users skin. This works on legacy counts as well.
         * @summary Changes the player skin by upload
        ...
        uploadPlayerSkin(strippedUuid: string, file: any, model?: SkinModel, options?: any) {
            return SkinOperationsApiFp(configuration).uploadPlayerSkin(strippedUuid, file, model, options)(fetch, basePath);
        },
    };
};
...
export class SkinOperationsApi extends BaseAPI {
    ...
    public changePlayerSkin(strippedUuid: string, url: string, model?: SkinModel, options?: any) {
        return SkinOperationsApiFp(this.configuration).changePlayerSkin(strippedUuid, url, model, options)(this.fetch, this.basePath);
    }
    ...
    public resetPlayerSkin(strippedUuid: string, options?: any) {
        return SkinOperationsApiFp(this.configuration).resetPlayerSkin(strippedUuid, options)(this.fetch, this.basePath);
    }
    ...
    public uploadPlayerSkin(strippedUuid: string, file: any, model?: SkinModel, options?: any) {
        return SkinOperationsApiFp(this.configuration).uploadPlayerSkin(strippedUuid, file, model, options)(this.fetch, this.basePath);
    }
