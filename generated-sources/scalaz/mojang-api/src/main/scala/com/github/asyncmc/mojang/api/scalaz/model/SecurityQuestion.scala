...
import SecurityQuestion._

case class SecurityQuestion (
...
object SecurityQuestion {
  ...
  implicit val SecurityQuestionCodecJson: CodecJson[SecurityQuestion] = CodecJson.derive[SecurityQuestion]
  implicit val SecurityQuestionDecoder: EntityDecoder[SecurityQuestion] = jsonOf[SecurityQuestion]
  implicit val SecurityQuestionEncoder: EntityEncoder[SecurityQuestion] = jsonEncoderOf[SecurityQuestion]
}
