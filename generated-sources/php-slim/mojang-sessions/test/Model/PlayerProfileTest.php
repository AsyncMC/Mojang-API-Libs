...
use com.github.asyncmc.mojang.sessions.php.slim.server\com.github.asyncmc.mojang.sessions.php.slim.model\PlayerProfile;

/**
 * PlayerProfileTest Class Doc Comment
 *
 * @category Class
 ...
 * @author   OpenAPI Generator team
 * @link     https://github.com/openapitools/openapi-generator
 * @coversDefaultClass \com.github.asyncmc.mojang.sessions.php.slim.server\com.github.asyncmc.mojang.sessions.php.slim.model\PlayerProfile
 */
class PlayerProfileTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $testPlayerProfile = new PlayerProfile();
    }
