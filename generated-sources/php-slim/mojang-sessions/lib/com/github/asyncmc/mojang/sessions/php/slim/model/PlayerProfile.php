...
class PlayerProfile
{
    ...
    /** @var \com.github.asyncmc.mojang.sessions.php.slim.server\com.github.asyncmc.mojang.sessions.php.slim.model\PlayerProfileProperty[] $properties An array with all player properties, like skin and cape*/
    private $properties;
}
