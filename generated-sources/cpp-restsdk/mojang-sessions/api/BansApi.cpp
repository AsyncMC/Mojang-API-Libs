...
pplx::task<utility::string_t> BansApi::getBlockedServerHashes()
{


    std::shared_ptr<ApiConfiguration> localVarApiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t localVarPath = utility::conversions::to_string_t("/blockedservers");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("BansApi->getBlockedServerHashes does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("BansApi->getBlockedServerHashes does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response localVarResponse)
    {
        ...
        if (localVarResponse.status_code() >= 400)
        {
            throw ApiException(localVarResponse.status_code()
                , utility::conversions::to_string_t("error calling getBlockedServerHashes: ") + localVarResponse.reason_phrase()
        ...
        if(localVarResponse.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            if( localVarContentType.find(localVarResponseHttpContentType) == std::string::npos )
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getBlockedServerHashes: unexpected response type: ") + localVarContentType
                    , std::make_shared<std::stringstream>(localVarResponse.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t localVarResponse)
    {
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getBlockedServerHashes: unsupported response type"));
        }
