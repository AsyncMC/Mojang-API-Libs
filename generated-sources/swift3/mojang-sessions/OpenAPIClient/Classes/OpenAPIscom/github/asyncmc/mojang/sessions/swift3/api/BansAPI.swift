...
open class BansAPI: APIBase {
    /**
     A list of SHA1 hashes of banned servers
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func getBlockedServerHashes(completion: @escaping ((_ data: String?, _ error: ErrorResponse?) -> Void)) {
     ...
     */
    open class func getBlockedServerHashesWithRequestBuilder() -> RequestBuilder<String> {
