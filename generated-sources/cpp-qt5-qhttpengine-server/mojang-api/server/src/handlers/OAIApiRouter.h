...
private:
    ...
    OAIMiscellaneousApiHandler *OAIMiscellaneousApiApiHandler;
    OAINameHistoryApiHandler *OAINameHistoryApiApiHandler;
    OAISecurityQuestionAnswerApiHandler *OAISecurityQuestionAnswerApiApiHandler;
    OAISkinOperationsApiHandler *OAISkinOperationsApiApiHandler;
protected:
