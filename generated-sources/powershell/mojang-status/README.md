# Org.OpenAPITools - the PowerShell module for the Mojang API
...
```powershell
using Org.OpenAPITools.com.github.asyncmc.mojang.status.powershell.api;
using Org.OpenAPITools.Client;
using Org.OpenAPITools.com.github.asyncmc.mojang.status.powershell.model;
```
