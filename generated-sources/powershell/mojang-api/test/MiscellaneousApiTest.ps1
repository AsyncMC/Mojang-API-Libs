...
Describe 'Org.OpenAPITools MiscellaneousApi' {
    Context 'MiscellaneousApi' {
        It 'Invoke-MiscellaneousApiGetOrdersStatistics' {
            $ret = Invoke-PetApiGetPetById -orderStatisticsRequest "TEST_VALUE"
