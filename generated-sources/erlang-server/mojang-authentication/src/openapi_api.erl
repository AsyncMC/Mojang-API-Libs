...
request_params('Authenticate') ->
    [
        'AuthenticationRequest'
    ];

request_params('Invalidate') ->
    [
        'AccessKeys'
    ];

request_params('Refresh') ->
    [
        'RefreshRequest'
    ];

request_params('Siginout') ->
    [
        'UsernamePassword'
    ];
...
request_param_info('Authenticate', 'AuthenticationRequest') ->
    #{
        source =>   body,
        rules => [
            schema,
...
request_param_info('Invalidate', 'AccessKeys') ->
    #{
        source =>   body,
        rules => [
            schema,
...
request_param_info('Refresh', 'RefreshRequest') ->
    #{
        source =>   body,
        rules => [
            schema,
...
request_param_info('Siginout', 'UsernamePassword') ->
    #{
        source =>   body,
        rules => [
            schema,
...
request_param_info('Validate', 'AccessKeys') ->
    #{
        source =>   body,
        rules => [
            schema,
...
validate_response('Authenticate', 200, Body, ValidatorState) ->
    validate_response_body('Authentication', 'Authentication', Body, ValidatorState);
validate_response('Authenticate', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);

validate_response('Invalidate', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('Invalidate', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);

validate_response('Refresh', 200, Body, ValidatorState) ->
    validate_response_body('RefreshResponse', 'RefreshResponse', Body, ValidatorState);
validate_response('Refresh', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);

validate_response('Siginout', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('Siginout', 400, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);

validate_response('Validate', 204, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('Validate', 403, Body, ValidatorState) ->
    validate_response_body('Error', 'Error', Body, ValidatorState);
