...
request_params('GetBlockedServerHashes') ->
    [
    ];


request_params('GetPlayerProfile') ->
    [
        'stripped_uuid',
        'unsigned'
    ];
...
request_param_info('GetPlayerProfile', 'stripped_uuid') ->
    #{
        source =>  binding ,
        rules => [
            {type, 'binary'},
...
request_param_info('GetPlayerProfile', 'unsigned') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'boolean'},
...
validate_response('GetBlockedServerHashes', 200, Body, ValidatorState) ->
    validate_response_body('binary', 'string', Body, ValidatorState);


validate_response('GetPlayerProfile', 200, Body, ValidatorState) ->
    validate_response_body('PlayerProfile', 'PlayerProfile', Body, ValidatorState);
validate_response('GetPlayerProfile', 400, Body, ValidatorState) ->
    validate_response_body('SessionApiError', 'SessionApiError', Body, ValidatorState);
