%% basic handler
-module(openapi_skin_operations_handler).
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ChangePlayerSkin' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ResetPlayerSkin' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'UploadPlayerSkin' = OperationID,
        logic_handler = LogicHandler
    }
) ->
