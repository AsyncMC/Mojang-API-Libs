%% basic handler
-module(openapi_security_question_answer_handler).
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'CheckSecurityStatus'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'ListPendingSecurityQuestions'
    }
) ->
    {[<<"GET">>], Req, State};
...
allowed_methods(
    Req,
    State = #state{
        operation_id = 'SendSecurityQuestionAnswers'
    }
) ->
    {[<<"POST">>], Req, State};
...
is_authorized(
    Req0,
    State = #state{
        operation_id = 'CheckSecurityStatus' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'ListPendingSecurityQuestions' = OperationID,
        logic_handler = LogicHandler
    }
) ->
is_authorized(
    Req0,
    State = #state{
        operation_id = 'SendSecurityQuestionAnswers' = OperationID,
        logic_handler = LogicHandler
    }
) ->
