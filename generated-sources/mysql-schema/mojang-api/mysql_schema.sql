...
--
-- Table structure for table `ChangeSkinRequest` generated from model 'ChangeSkinRequest'
-- Request Mojang to download a skin from an URL and apply to the player
--

CREATE TABLE IF NOT EXISTS `ChangeSkinRequest` (
...
--
-- Table structure for table `UploadSkinRequest` generated from model 'UploadSkinRequest'
--

CREATE TABLE IF NOT EXISTS `UploadSkinRequest` (
  `model` TEXT DEFAULT NULL,
