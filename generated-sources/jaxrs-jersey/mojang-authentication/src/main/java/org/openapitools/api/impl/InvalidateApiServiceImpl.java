...
public class InvalidateApiServiceImpl extends InvalidateApiService {
    @Override
    public Response invalidate(AccessKeys accessKeys, SecurityContext securityContext) throws NotFoundException {
        // do some magic!
