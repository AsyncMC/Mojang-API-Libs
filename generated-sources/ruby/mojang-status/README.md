...
------------ | ------------- | ------------- | -------------
*OpenapiClient::DefaultApi* | [**check_statuses**](docs/DefaultApi.md#check_statuses) | **GET** /check | Checks the Mojang service statuses


## Documentation for Models

 - [OpenapiClient::ApiStatus](docs/ApiStatus.md)
