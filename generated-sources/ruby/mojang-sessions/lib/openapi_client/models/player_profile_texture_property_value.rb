...
module OpenapiClient
  ...
  class PlayerProfileTexturePropertyValue
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'profileName')
        self.profile_name = attributes[:'profileName']
      end

      if attributes.has_key?(:'signatureRequired')
        self.signature_required = attributes[:'signatureRequired']
      else
        self.signature_required = false
      end

      if attributes.has_key?(:'textures')
    ...
    def hash
      [timestamp, profile_id, profile_name, signature_required, textures].hash
    end
