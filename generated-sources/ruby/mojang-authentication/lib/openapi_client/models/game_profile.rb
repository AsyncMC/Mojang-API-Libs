...
module OpenapiClient
  class GameProfile
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'legacyProfile')
        self.legacy_profile = attributes[:'legacyProfile']
      end
      ...
      if attributes.has_key?(:'migrated')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          legacy_profile == o.legacy_profile &&
    ...
    def hash
      [agent, id, name, user_id, created_at, legacy_profile, suspended, paid, migrated, legacy].hash
    end
