...
module OpenapiClient
  ...
  class NameChange
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'changedToAt')
        self.changed_to_at = attributes[:'changedToAt']
      end
    end
