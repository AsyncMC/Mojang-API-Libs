...
open class SkinOperationsAPI {
     ...
     */
    open class func changePlayerSkin(strippedUuid: String, url: String, model: SkinModel? = nil, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func resetPlayerSkin(strippedUuid: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func uploadPlayerSkin(strippedUuid: String, file: URL, model: SkinModel? = nil, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
