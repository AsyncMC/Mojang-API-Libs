...
open class MiscellaneousAPI {
     ...
     */
    open class func getOrdersStatistics(orderStatisticsRequest: OrderStatisticsRequest, completion: @escaping ((_ data: OrderStatisticsResponse?,_ error: Error?) -> Void)) {
    ...
    open class func getOrdersStatisticsWithRequestBuilder(orderStatisticsRequest: OrderStatisticsRequest) -> RequestBuilder<OrderStatisticsResponse> {
        ...
        let parameters = JSONEncodingHelper.encodingParameters(forEncodableObject: orderStatisticsRequest)
