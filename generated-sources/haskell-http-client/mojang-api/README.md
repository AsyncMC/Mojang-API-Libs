## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Mojang API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Mojang API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | Mojang                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | mojang                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | MojangConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | MojangRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| Mojang.Client    | use the "dispatch" functions to send requests       |
| Mojang.Core      | core funcions, config and request types             |
| Mojang.API       | construct api requests                              |
| Mojang.Model     | describes api models                                |
| Mojang.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| Mojang.ModelLens | lenses for model fields                             |
| Mojang.Logging   | logging functions and utils                         |
