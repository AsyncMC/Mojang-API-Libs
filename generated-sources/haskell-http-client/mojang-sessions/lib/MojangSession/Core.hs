...
module MojangSession.Core where
...
-- | 
data MojangSessionConfig = MojangSessionConfig
...
-- | display the config
instance P.Show MojangSessionConfig where
  show c =
    T.printf
...
-- | constructs a default MojangSessionConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"mojang-session/0.1.0.0"@
--
newConfig :: IO MojangSessionConfig
newConfig = do
    logCxt <- initLogContext
    return $ MojangSessionConfig
        { configHost = "https://sessionserver.mojang.com"
        , configUserAgent = "mojang-session/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => MojangSessionConfig -> auth -> MojangSessionConfig
addAuthMethod config@MojangSessionConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: MojangSessionConfig -> IO MojangSessionConfig
...
withStderrLogging :: MojangSessionConfig -> IO MojangSessionConfig
...
withNoLogging :: MojangSessionConfig -> MojangSessionConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}
 
-- * MojangSessionRequest
...
data MojangSessionRequest req contentType res accept = MojangSessionRequest
  { rMethod  :: NH.Method   -- ^ Method of MojangSessionRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of MojangSessionRequest
  , rParams   :: Params -- ^ params of MojangSessionRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (MojangSessionRequest req contentType res accept) NH.Method
rMethodL f MojangSessionRequest{..} = (\rMethod -> MojangSessionRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (MojangSessionRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f MojangSessionRequest{..} = (\rUrlPath -> MojangSessionRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (MojangSessionRequest req contentType res accept) Params
rParamsL f MojangSessionRequest{..} = (\rParams -> MojangSessionRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (MojangSessionRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f MojangSessionRequest{..} = (\rAuthTypes -> MojangSessionRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => MojangSessionRequest req contentType res accept -> param -> MojangSessionRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: MojangSessionRequest req contentType res accept -> param -> MojangSessionRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: MojangSessionRequest req contentType res accept -> param -> MojangSessionRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** MojangSessionRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> MojangSessionRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = MojangSessionRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: MojangSessionRequest req contentType res accept -> [NH.Header] -> MojangSessionRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: MojangSessionRequest req contentType res accept -> [NH.HeaderName] -> MojangSessionRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => MojangSessionRequest req contentType res accept -> MojangSessionRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => MojangSessionRequest req contentType res accept -> MojangSessionRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: MojangSessionRequest req contentType res accept -> [NH.QueryItem] -> MojangSessionRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: MojangSessionRequest req contentType res accept -> WH.Form -> MojangSessionRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: MojangSessionRequest req contentType res accept -> NH.Part -> MojangSessionRequest req contentType res accept
...
_setBodyBS :: MojangSessionRequest req contentType res accept -> B.ByteString -> MojangSessionRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: MojangSessionRequest req contentType res accept -> BL.ByteString -> MojangSessionRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => MojangSessionRequest req contentType res accept -> P.Proxy authMethod -> MojangSessionRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: MojangSessionConfig
    -> a
    -> MojangSessionRequest req contentType res accept
    -> IO (MojangSessionRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> MojangSessionConfig
  -> IO (MojangSessionRequest req contentType res accept)
_applyAuthMethods req config@(MojangSessionConfig {configAuthMethods = as}) =
  foldlM go req as
  where
