## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Mojang Session API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Mojang Session API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | MojangSession                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | mojang-session                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | MojangSessionConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | MojangSessionRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| MojangSession.Client    | use the "dispatch" functions to send requests       |
| MojangSession.Core      | core funcions, config and request types             |
| MojangSession.API       | construct api requests                              |
| MojangSession.Model     | describes api models                                |
| MojangSession.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| MojangSession.ModelLens | lenses for model fields                             |
| MojangSession.Logging   | logging functions and utils                         |
