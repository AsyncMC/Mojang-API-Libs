...
module MojangAuthentication.Client where
...
dispatchLbs
  ...
  -> MojangAuthenticationConfig -- ^ config
  -> MojangAuthenticationRequest req contentType res accept -- ^ request
