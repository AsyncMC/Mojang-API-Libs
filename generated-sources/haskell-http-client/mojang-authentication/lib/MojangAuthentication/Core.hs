...
module MojangAuthentication.Core where
...
-- * MojangAuthenticationConfig

-- | 
data MojangAuthenticationConfig = MojangAuthenticationConfig
...
-- | display the config
instance P.Show MojangAuthenticationConfig where
  show c =
    T.printf
...
-- | constructs a default MojangAuthenticationConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"mojang-authentication/0.1.0.0"@
--
newConfig :: IO MojangAuthenticationConfig
newConfig = do
    logCxt <- initLogContext
    return $ MojangAuthenticationConfig
        { configHost = "https://authserver.mojang.com"
        , configUserAgent = "mojang-authentication/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => MojangAuthenticationConfig -> auth -> MojangAuthenticationConfig
addAuthMethod config@MojangAuthenticationConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: MojangAuthenticationConfig -> IO MojangAuthenticationConfig
...
withStderrLogging :: MojangAuthenticationConfig -> IO MojangAuthenticationConfig
...
withNoLogging :: MojangAuthenticationConfig -> MojangAuthenticationConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}
 
-- * MojangAuthenticationRequest
...
data MojangAuthenticationRequest req contentType res accept = MojangAuthenticationRequest
  { rMethod  :: NH.Method   -- ^ Method of MojangAuthenticationRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of MojangAuthenticationRequest
  , rParams   :: Params -- ^ params of MojangAuthenticationRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (MojangAuthenticationRequest req contentType res accept) NH.Method
rMethodL f MojangAuthenticationRequest{..} = (\rMethod -> MojangAuthenticationRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (MojangAuthenticationRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f MojangAuthenticationRequest{..} = (\rUrlPath -> MojangAuthenticationRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (MojangAuthenticationRequest req contentType res accept) Params
rParamsL f MojangAuthenticationRequest{..} = (\rParams -> MojangAuthenticationRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (MojangAuthenticationRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f MojangAuthenticationRequest{..} = (\rAuthTypes -> MojangAuthenticationRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => MojangAuthenticationRequest req contentType res accept -> param -> MojangAuthenticationRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: MojangAuthenticationRequest req contentType res accept -> param -> MojangAuthenticationRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: MojangAuthenticationRequest req contentType res accept -> param -> MojangAuthenticationRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** MojangAuthenticationRequest Utils

_mkRequest :: NH.Method -- ^ Method 
          -> [BCL.ByteString] -- ^ Endpoint
          -> MojangAuthenticationRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = MojangAuthenticationRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader :: MojangAuthenticationRequest req contentType res accept -> [NH.Header] -> MojangAuthenticationRequest req contentType res accept
setHeader req header =
  req `removeHeader` P.fmap P.fst header &
  L.over (rParamsL . paramsHeadersL) (header P.++)

removeHeader :: MojangAuthenticationRequest req contentType res accept -> [NH.HeaderName] -> MojangAuthenticationRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => MojangAuthenticationRequest req contentType res accept -> MojangAuthenticationRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of 
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => MojangAuthenticationRequest req contentType res accept -> MojangAuthenticationRequest req contentType res accept
_setAcceptHeader req =
    case mimeType (P.Proxy :: P.Proxy accept) of 
        Just m -> req `setHeader` [("accept", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["accept"]

setQuery :: MojangAuthenticationRequest req contentType res accept -> [NH.QueryItem] -> MojangAuthenticationRequest req contentType res accept
setQuery req query = 
  req &
  L.over
...
addForm :: MojangAuthenticationRequest req contentType res accept -> WH.Form -> MojangAuthenticationRequest req contentType res accept
addForm req newform = 
...
_addMultiFormPart :: MojangAuthenticationRequest req contentType res accept -> NH.Part -> MojangAuthenticationRequest req contentType res accept
...
_setBodyBS :: MojangAuthenticationRequest req contentType res accept -> B.ByteString -> MojangAuthenticationRequest req contentType res accept
_setBodyBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: MojangAuthenticationRequest req contentType res accept -> BL.ByteString -> MojangAuthenticationRequest req contentType res accept
_setBodyLBS req body = 
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => MojangAuthenticationRequest req contentType res accept -> P.Proxy authMethod -> MojangAuthenticationRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    :: MojangAuthenticationConfig
    -> a
    -> MojangAuthenticationRequest req contentType res accept
    -> IO (MojangAuthenticationRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> MojangAuthenticationConfig
  -> IO (MojangAuthenticationRequest req contentType res accept)
_applyAuthMethods req config@(MojangAuthenticationConfig {configAuthMethods = as}) =
  foldlM go req as
  where
