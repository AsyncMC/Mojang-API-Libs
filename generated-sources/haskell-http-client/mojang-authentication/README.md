## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `Mojang Authentication API`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the Mojang Authentication API API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | MojangAuthentication                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | mojang-authentication                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | MojangAuthenticationConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | MojangAuthenticationRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| MojangAuthentication.Client    | use the "dispatch" functions to send requests       |
| MojangAuthentication.Core      | core funcions, config and request types             |
| MojangAuthentication.API       | construct api requests                              |
| MojangAuthentication.Model     | describes api models                                |
| MojangAuthentication.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| MojangAuthentication.ModelLens | lenses for model fields                             |
| MojangAuthentication.Logging   | logging functions and utils                         |
