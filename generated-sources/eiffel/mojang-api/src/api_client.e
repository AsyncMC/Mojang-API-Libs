...
feature {NONE} -- Initialization
	...
	make
		do
			...
			authentications.force (create {HTTP_BASIC_AUTH}, "MojangStatisticsToken") 
			is_basic_auth_configured := True 
			authentications.force (create {HTTP_BASIC_AUTH}, "PlayerAccessToken") 
			is_basic_auth_configured := True 
		end

feature -- Access

	default_base_path: STRING = "https://api.mojang.com"
			-- default base path.
