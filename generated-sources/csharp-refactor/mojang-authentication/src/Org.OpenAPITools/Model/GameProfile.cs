...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class GameProfile :  IEquatable<GameProfile>, IValidatableObject
    {
        ...
        public GameProfile(string agent = default(string), string id = default(string), string name = default(string), System.IO.Stream userId = default(System.IO.Stream), long? createdAt = default(long?), bool? legacyProfile = default(bool?), bool? suspended = default(bool?), bool? paid = default(bool?), bool? migrated = default(bool?), bool? legacy = default(bool?))
        {
            this.Agent = agent;
            this.Id = id;
            this.Name = name;
