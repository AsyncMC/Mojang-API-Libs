...
--
--  src/com-github-asyncmc-mojang-sessions-ada-server-model-servers.ads
--
--  Then, you can drop this edit note comment.
--  ------------ EDIT NOTE ------------
with Swagger.Servers;
with com.github.asyncmc.mojang.sessions.ada.server.model.Models;
with com.github.asyncmc.mojang.sessions.ada.server.model.Skeletons;
package com.github.asyncmc.mojang.sessions.ada.server.model.Servers is
   use com.github.asyncmc.mojang.sessions.ada.server.model.Models;
   type Server_Type is limited new com.github.asyncmc.mojang.sessions.ada.server.model.Skeletons.Server_Type with null record;
   ...
   package Server_Impl is
      new com.github.asyncmc.mojang.sessions.ada.server.model.Skeletons.Shared_Instance (Server_Type);

end com.github.asyncmc.mojang.sessions.ada.server.model.Servers;
