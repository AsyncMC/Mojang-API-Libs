...
package .Models is
   ...
   type PlayerTexture_Type is
     record
       S_K_I_N : .Models.PlayerSkinURL_Type;
       C_A_P_E : .Models.PlayerTextureURL_Type;
     end record;
   ...
   type PlayerProfileTexturePropertyValue_Type is
     record
       ...
       Textures : .Models.PlayerTexture_Type;
     end record;
   ...
   type PlayerProfile_Type is
     record
       ...
       Properties : .Models.PlayerProfileProperty_Type_Vectors.Vector;
     end record;
