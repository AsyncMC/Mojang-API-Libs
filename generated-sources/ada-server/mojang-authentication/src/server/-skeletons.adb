...
package body .Skeletons is
   ...
   package body Skeleton is
      ...
      procedure Authenticate
         ...
         Result : .Models.Authentication_Type;
      begin
         Swagger.Servers.Read (Req, Input);
         
         .Models.Deserialize (Input, "AuthenticationRequest_Type", Authentication_Request_Type);
         Impl.Authenticate
      ...
      begin
         ...
         .Models.Deserialize (Input, "AccessKeys_Type", Access_Keys_Type);
         Impl.Invalidate
      ...
      procedure Refresh
         ...
         Result : .Models.RefreshResponse_Type;
      begin
         Swagger.Servers.Read (Req, Input);
         
         .Models.Deserialize (Input, "RefreshRequest_Type", Refresh_Request_Type);
         Impl.Refresh
      ...
      begin
         ...
         .Models.Deserialize (Input, "UsernamePassword_Type", Username_Password_Type);
         Impl.Siginout
