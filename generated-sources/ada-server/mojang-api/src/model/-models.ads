...
package .Models is
   ...
   type SecurityChallenge_Type is
     record
       Question : .Models.SecurityQuestion_Type;
       Answer : .Models.SecurityAnswerId_Type;
     end record;
   ...
   type Inline_object_1_Type is
     record
       Model : .Models.SkinModel_Type;
       Url : Swagger.UString;
     end record;

   package Inline_object_1_Type_Vectors is
      new Ada.Containers.Vectors (Index_Type   => Positive,
                                  Element_Type => Inline_object_1_Type);

   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Inline_object_1_Type);

   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Inline_object_1_Type_Vectors.Vector);

   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Inline_object_1_Type);

   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Inline_object_1_Type_Vectors.Vector);
   ...
   type OrderStatisticsRequest_Type is
     record
       Metric_Keys : .Models.OrderStatistic_Type_Vectors.Vector;
     end record;
   ...
   type Inline_object_Type is
     record
       Model : .Models.SkinModel_Type;
       File : Swagger.Http_Content_Type;
     end record;

   package Inline_object_Type_Vectors is
      new Ada.Containers.Vectors (Index_Type   => Positive,
                                  Element_Type => Inline_object_Type);

   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Inline_object_Type);

   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Inline_object_Type_Vectors.Vector);

   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Inline_object_Type);

   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Inline_object_Type_Vectors.Vector);
