...
with com.github.asyncmc.mojang.status.ada.server.model.Servers;
procedure com.github.asyncmc.mojang.status.ada.server.model.Server is
   procedure Configure (Config : in out AWS.Config.Object);

   CONFIG_PATH  : constant String := "com.github.asyncmc.mojang.status.ada.server.model.properties";
   ...
   Log     : constant Util.Log.Loggers.Logger := Util.Log.Loggers.Create ("com.github.asyncmc.mojang.status.ada.server.model.Server");
...
begin
   ...
   App.Configure (Props);
   com.github.asyncmc.mojang.status.ada.server.model.Servers.Server_Impl.Register (App);
...
end com.github.asyncmc.mojang.status.ada.server.model.Server;
