...
public class ExecuteReport {
  ...
  private static void generateReport() {
    ...
    reportOutputDirectory = new File("./report/Login-report-html/");
    jsonFiles = new ArrayList();
    jsonFiles.add("./report/Login-report-json/Login.json");
    ...
    reportOutputDirectory = new File("./report/Bans-report-html/");
    jsonFiles = new ArrayList();
    jsonFiles.add("./report/Bans-report-json/Bans.json");
