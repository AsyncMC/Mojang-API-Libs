...
public interface ValidateApi {
    ...
    @ApiOperation(value = "", nickname = "validate", notes = "", tags={  })
    @ApiResponses(value = { 
    ...
    default ResponseEntity<Void> validate(@ApiParam(value = "" ,required=true )  @Valid @RequestBody AccessKeys accessKeys) {
