...
- API version: 2020-06-05
  - Build date: 2020-06-06T02:32:26.085625400-03:00[America/Sao_Paulo]
...
<dependency>
  ...
  <artifactId>mojang-api-java</artifactId>
...
```groovy
compile "com.github.asyncmc:mojang-api-java:1.0.0"
```
...
* `target/mojang-api-java-1.0.0.jar`
* `target/lib/*.jar`
...
import com.github.asyncmc.mojang.api.java.server.*;
import com.github.asyncmc.mojang.api.java.server.auth.*;
import com.github.asyncmc.mojang.api.java.model.*;
