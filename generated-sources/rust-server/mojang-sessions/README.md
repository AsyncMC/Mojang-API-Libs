...
- Build date: 2020-06-05T23:35:43.223546100-03:00[America/Sao_Paulo]
...
```
cargo run --example client GetBlockedServerHashes
cargo run --example client GetPlayerProfile
```
