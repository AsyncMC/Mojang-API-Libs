    ...
    C: Has<XSpanIdString>  + 'static
{
    ...
    fn call(&self, (req, mut context): Self::Request) -> Self::Future {
        ...
        match &method {
            ...
            // CheckStatuses - GET /check
            &hyper::Method::Get if path.matched(paths::ID_CHECK) => {
                ...
                Box::new({
                        {{
                                ...
                                Box::new(api_impl.check_statuses(&context)
                                    .then(move |result| {
                                        ...
                                        match result {
                                            Ok(rsp) => match rsp {
                                                CheckStatusesResponse::AnArrayWithServiceStatusKey
                                                ...
                                                => {
                                                    ...
                                                    response.headers_mut().set(ContentType(mimetypes::responses::CHECK_STATUSES_AN_ARRAY_WITH_SERVICE_STATUS_KEY.clone()));
...
impl RequestParser for ApiRequestParser {
    fn parse_operation_id(request: &Request) -> Result<&'static str, ()> {
        ...
        match request.method() {
            ...
            // CheckStatuses - GET /check
            &hyper::Method::Get if path.matched(paths::ID_CHECK) => Ok("CheckStatuses"),
            _ => Err(()),
        }
    }
}
