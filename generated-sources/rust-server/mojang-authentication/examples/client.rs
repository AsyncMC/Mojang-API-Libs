...
fn main() {
    let matches = App::new("client")
        ...
        .arg(Arg::with_name("host")
            .long("host")
            .takes_value(true)
            .default_value("authserver.mojang.com")
    ...
    match matches.value_of("operation") {
        ...
        // Some("Authenticate") => {
        //     let result = core.run(client.authenticate(???));
        //     println!("{:?} (X-Span-ID: {:?})", result, (client.context() as &Has<XSpanIdString>).get().clone());
        //  },

        // Disabled because there's no example.
        // Some("Invalidate") => {
        //     let result = core.run(client.invalidate(???));
        //     println!("{:?} (X-Span-ID: {:?})", result, (client.context() as &Has<XSpanIdString>).get().clone());
        //  },

        // Disabled because there's no example.
        // Some("Refresh") => {
        //     let result = core.run(client.refresh(???));
        //     println!("{:?} (X-Span-ID: {:?})", result, (client.context() as &Has<XSpanIdString>).get().clone());
        //  },

        // Disabled because there's no example.
        // Some("Siginout") => {
        //     let result = core.run(client.siginout(???));
        //     println!("{:?} (X-Span-ID: {:?})", result, (client.context() as &Has<XSpanIdString>).get().clone());
        //  },

        // Disabled because there's no example.
        // Some("Validate") => {
        //     let result = core.run(client.validate(???));
        //     println!("{:?} (X-Span-ID: {:?})", result, (client.context() as &Has<XSpanIdString>).get().clone());
        //  },
