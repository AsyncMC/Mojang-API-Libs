...
- Build date: 2020-06-05T23:35:42.357741100-03:00[America/Sao_Paulo]
...
```
cargo run --example client Authenticate
cargo run --example client Invalidate
cargo run --example client Refresh
cargo run --example client Siginout
cargo run --example client Validate
```
