...
impl<F, C> Api<C> for Client<F> where
    ...
    fn authenticate(&self, param_authentication_request: models::AuthenticationRequest, context: &C) -> Box<Future<Item=AuthenticateResponse, Error=ApiError>> {
        ...
        let body = serde_json::to_string(&param_authentication_request).expect("impossible to fail to serialize");


        request.set_body(body.into_bytes());


        request.headers_mut().set(ContentType(mimetypes::requests::AUTHENTICATE.clone()));
            ...
            match response.status().as_u16() {
                    ...
                    Box::new(
                        ...
                        .and_then(|body| str::from_utf8(&body)
                                             ...
                                             .and_then(|body|
                                                 ...
                                                 serde_json::from_str::<models::Authentication>(body)
                                                     .map_err(|e| e.into())

                                             ))
                        .map(move |body|
                            AuthenticateResponse::SuccessfullyAuthenticated(body)
                        )
                ...
                400 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body|
                            AuthenticateResponse::CouldNotAuthenticate(body)
                        )
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn invalidate(&self, param_access_keys: models::AccessKeys, context: &C) -> Box<Future<Item=InvalidateResponse, Error=ApiError>> {
        ...
        let body = serde_json::to_string(&param_access_keys).expect("impossible to fail to serialize");


        request.set_body(body.into_bytes());


        request.headers_mut().set(ContentType(mimetypes::requests::INVALIDATE.clone()));
        request.headers_mut().set(XSpanId((context as &Has<XSpanIdString>).get().0.clone()));
            ...
            match response.status().as_u16() {
                ...
                400 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body|
                            InvalidateResponse::CouldNotInvalidateTheToken(body)
                        )
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn refresh(&self, param_refresh_request: models::RefreshRequest, context: &C) -> Box<Future<Item=RefreshResponse, Error=ApiError>> {
        ...
        let body = serde_json::to_string(&param_refresh_request).expect("impossible to fail to serialize");


        request.set_body(body.into_bytes());


        request.headers_mut().set(ContentType(mimetypes::requests::REFRESH.clone()));
        request.headers_mut().set(XSpanId((context as &Has<XSpanIdString>).get().0.clone()));
                    ...
                    Box::new(
                        ...
                        .and_then(|body| str::from_utf8(&body)
                                             ...
                                             .and_then(|body|
                                                 ...
                                                 serde_json::from_str::<models::RefreshResponse>(body)
                                                     .map_err(|e| e.into())

                                             ))
                        .map(move |body|
                            RefreshResponse::SessionRefreshedSuccessfully(body)
                        )
                    ) as Box<Future<Item=_, Error=_>>
                },
                400 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body|
                            RefreshResponse::CouldNotRefreshTheSession(body)
                        )
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn siginout(&self, param_username_password: models::UsernamePassword, context: &C) -> Box<Future<Item=SiginoutResponse, Error=ApiError>> {
        ...
        let body = serde_json::to_string(&param_username_password).expect("impossible to fail to serialize");


        request.set_body(body.into_bytes());


        request.headers_mut().set(ContentType(mimetypes::requests::SIGINOUT.clone()));
        request.headers_mut().set(XSpanId((context as &Has<XSpanIdString>).get().0.clone()));
            ...
            match response.status().as_u16() {
                ...
                400 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body|
                            SiginoutResponse::InvalidUsername(body)
                        )
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
    ...
    fn validate(&self, param_access_keys: models::AccessKeys, context: &C) -> Box<Future<Item=ValidateResponse, Error=ApiError>> {
        ...
        request.headers_mut().set(ContentType(mimetypes::requests::VALIDATE.clone()));
        request.headers_mut().set(XSpanId((context as &Has<XSpanIdString>).get().0.clone()));
            ...
            match response.status().as_u16() {
                ...
                403 => {
                    ...
                    Box::new(
                        ...
                        .map(move |body|
                            ValidateResponse::TheTokenIsNotValid(body)
                        )
                    ) as Box<Future<Item=_, Error=_>>
                },
                code => {
