...
#
package WWW::OpenAPIClient::Object::ChangeSkinRequest;
...
__PACKAGE__->class_documentation({description => 'Request Mojang to download a skin from an URL and apply to the player',
