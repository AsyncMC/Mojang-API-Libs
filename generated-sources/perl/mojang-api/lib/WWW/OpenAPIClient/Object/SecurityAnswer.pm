...
#
package WWW::OpenAPIClient::Object::SecurityAnswer;
...
__PACKAGE__->class_documentation({description => 'A security question answer given by the player using the id given by Mojang',
