...
#
package WWW::OpenAPIClient::Object::CurrentPlayerIDs;
...
__PACKAGE__->class_documentation({description => 'The current player, demo and legacy status of a player identified by the id',
