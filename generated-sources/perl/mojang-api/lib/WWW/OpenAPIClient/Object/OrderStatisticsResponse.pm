...
#
package WWW::OpenAPIClient::Object::OrderStatisticsResponse;
...
__PACKAGE__->class_documentation({description => 'A json object is returned with the total amount of copies sold, the amount of copies sold in the last 24h and how many sales there are per second.',
...
__PACKAGE__->method_documentation({
    ...
    'sale_velocity_per_seconds' => {
    	datatype => 'double',
    	base_name => 'saleVelocityPerSeconds',
