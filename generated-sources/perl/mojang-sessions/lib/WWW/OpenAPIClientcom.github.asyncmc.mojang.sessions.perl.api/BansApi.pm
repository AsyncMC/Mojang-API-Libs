...
#
package WWW::OpenAPIClient::BansApi;
...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'get_blocked_server_hashes' } = { 
...
# @return string
#
sub get_blocked_server_hashes {
    my ($self, %args) = @_;

    # parse inputs
    my $_resource_path = '/blockedservers';
