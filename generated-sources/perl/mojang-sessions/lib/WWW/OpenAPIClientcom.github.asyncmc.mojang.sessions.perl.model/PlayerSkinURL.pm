...
#
package WWW::OpenAPIClient::Object::PlayerSkinURL;
...
__PACKAGE__->class_documentation({description => 'Wraps the URL to the texture and configures the player&#39;s model',
                                  class => 'PlayerSkinURL',
                                  required => [], # TODO
}                                 );
