...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MojangApi.SecurityChallenge();
  });
  ...
  describe('SecurityChallenge', function() {
    it('should create an instance of SecurityChallenge', function() {
      // uncomment below and update the code to test SecurityChallenge
      //var instance = new MojangApi.SecurityChallenge();
      //expect(instance).to.be.a(MojangApi.SecurityChallenge);
    });
