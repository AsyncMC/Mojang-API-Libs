...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.MojangApi.SecurityQuestion = factory(root.MojangApi.ApiClient);
  }
  ...
  /**
   * Constructs a <code>SecurityQuestion</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:com.github.asyncmc.mojang.api.javascript.server/com.github.asyncmc.mojang.api.javascript.model/SecurityQuestion} obj Optional instance to populate.
   * @return {module:com.github.asyncmc.mojang.api.javascript.server/com.github.asyncmc.mojang.api.javascript.model/SecurityQuestion} The populated <code>SecurityQuestion</code> instance.
   */
