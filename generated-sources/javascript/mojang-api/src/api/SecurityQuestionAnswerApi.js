...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Error', 'model/SecurityAnswer', 'model/SecurityChallenge'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Error'), require('../model/SecurityAnswer'), require('../model/SecurityChallenge'));
  } else {
   ...
   * @module api/SecurityQuestionAnswerApi
   * @version 2020-06-05
   */

  /**
   * Constructs a new SecurityQuestionAnswerApi. 
   * @alias module:api/SecurityQuestionAnswerApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/SecurityQuestionAnswerApi~checkSecurityStatusCallback
     ...
     * @param {module:api/SecurityQuestionAnswerApi~checkSecurityStatusCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/SecurityQuestionAnswerApi~listPendingSecurityQuestionsCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/SecurityChallenge>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */

    /**
     * Get list of questions
     * @param {module:api/SecurityQuestionAnswerApi~listPendingSecurityQuestionsCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/SecurityChallenge>}
     */
     ...
     * @callback module:api/SecurityQuestionAnswerApi~sendSecurityQuestionAnswersCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/SecurityQuestionAnswerApi~sendSecurityQuestionAnswersCallback} callback The callback function, accepting three arguments: error, data, response
     */
