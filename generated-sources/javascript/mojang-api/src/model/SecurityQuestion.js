...
(function(root, factory) {
   ...
   * @alias module:model/SecurityQuestion
   * @class
   ...
   * @param {module:model/SecurityQuestion} obj Optional instance to populate.
   * @return {module:model/SecurityQuestion} The populated <code>SecurityQuestion</code> instance.
   */
