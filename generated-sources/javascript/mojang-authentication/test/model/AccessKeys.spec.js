...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new MojangAuthenticationApi.AccessKeys();
  });
  ...
  describe('AccessKeys', function() {
    it('should create an instance of AccessKeys', function() {
      ...
      //var instance = new MojangAuthenticationApi.AccessKeys();
      //expect(instance).to.be.a(MojangAuthenticationApi.AccessKeys);
    });
