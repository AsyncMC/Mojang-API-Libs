...
static bool checkStatusesProcessor(MemoryStruct_s p_chunk, long code, char* errormsg, void* userData,
	void(* voidHandler)())
{
...
static bool checkStatusesHelper(char * accessToken,
	...
	, void* userData, bool isAsync)
{
	...
	if(!isAsync){
		...
		bool retval = checkStatusesProcessor(*p_chunk, code, errormsg, userData,reinterpret_cast<void(*)()>(handler));
		...
		requestInfo = new(nothrow) RequestInfo (DefaultManager::getBasePath(), url, myhttpmethod, queryParams,
			mBody, headerList, p_chunk, &code, errormsg, userData, reinterpret_cast<void(*)()>(handler), checkStatusesProcessor);;
		if(requestInfo == NULL)
			return false;
...
bool DefaultManager::checkStatusesAsync(char * accessToken,
	
	void(* handler)(std::list<std::map>, Error, void* )
	, void* userData)
{
	return checkStatusesHelper(accessToken,
	
	handler, userData, true);
}

bool DefaultManager::checkStatusesSync(char * accessToken,
