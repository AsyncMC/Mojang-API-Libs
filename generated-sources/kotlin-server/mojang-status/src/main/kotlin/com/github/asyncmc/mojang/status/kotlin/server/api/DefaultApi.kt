...
*/
package com.github.asyncmc.mojang.status.kotlin.server.api
...
import com.github.asyncmc.mojang.status.kotlin.server.model.ApiStatus

fun Route.DefaultApi() {
    val gson = Gson()
    val empty = mutableMapOf<String, Any?>()

    get<Paths.checkStatuses> {  it: Paths.checkStatuses ->
