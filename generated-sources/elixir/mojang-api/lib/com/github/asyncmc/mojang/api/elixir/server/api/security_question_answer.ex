...
defmodule com.github.asyncmc.mojang.api.elixir.server.Api.SecurityQuestionAnswer do
  @moduledoc """
  ...
  {:error, info} on failure
  """
  @spec list_pending_security_questions(Tesla.Env.client, keyword()) :: {:ok, list(com.github.asyncmc.mojang.api.elixir.server.Model.SecurityChallenge.t)} | {:error, Tesla.Env.t}
  def list_pending_security_questions(connection, _opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode([%com.github.asyncmc.mojang.api.elixir.server.Model.SecurityChallenge{}])
  end
  ...
  {:error, info} on failure
  """
  @spec send_security_question_answers(Tesla.Env.client, list(com.github.asyncmc.mojang.api.elixir.server.Model.SecurityAnswer.t), keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
