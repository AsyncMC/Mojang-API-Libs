...
defmodule com.github.asyncmc.mojang.api.elixir.server.Model.OrderStatisticsResponse do
  @moduledoc """
...
defimpl Poison.Decoder, for: com.github.asyncmc.mojang.api.elixir.server.Model.OrderStatisticsResponse do
