...
defmodule MojangAPI.Api.NameHistory do
  @moduledoc """
  ...
  """
  @spec find_unique_ids_by_name(Tesla.Env.client, list(String.t), keyword()) :: {:ok, list(MojangAPI.Model.CurrentPlayerIDs.t)} | {:error, Tesla.Env.t}
  def find_unique_ids_by_name(connection, request_body, _opts \\ []) do
    ...
    |> decode([%MojangAPI.Model.CurrentPlayerIDs{}])
  end
  ...
  {:error, info} on failure
  """
  @spec get_name_history(Tesla.Env.client, String.t, keyword()) :: {:ok, list(MojangAPI.Model.NameChange.t)} | {:error, Tesla.Env.t}
  def get_name_history(connection, stripped_uuid, _opts \\ []) do
    ...
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> decode([%MojangAPI.Model.NameChange{}])
  end
  ...
  {:ok, %MojangAPI.Model.CurrentPlayerIDs{}} on success
  {:error, info} on failure
  """
  @spec get_unique_id_by_name(Tesla.Env.client, String.t, keyword()) :: {:ok, MojangAPI.Model.CurrentPlayerIDs.t} | {:error, Tesla.Env.t}
