...
class SecurityQuestion {
  ...
  static List<SecurityQuestion> listFromJson(List<dynamic> json) {
    return json == null ? new List<SecurityQuestion>() : json.map((value) => new SecurityQuestion.fromJson(value)).toList();
  }

  static Map<String, SecurityQuestion> mapFromJson(Map<String, dynamic> json) {
    var map = new Map<String, SecurityQuestion>();
    if (json != null && json.length > 0) {
      json.forEach((String key, dynamic value) => map[key] = new SecurityQuestion.fromJson(value));
    }
    return map;
  }
}
