# REST API Server for Mojang Authentication API
...
## Namespaces
com.github.asyncmc.mojang.authentication.cpp.pistache.server.api
com.github.asyncmc.mojang.authentication.cpp.pistache.server.model
