# REST API Server for Mojang Session API
...
## Namespaces
com.github.asyncmc.mojang.sessions.cpp.pistache.server.api
com.github.asyncmc.mojang.sessions.cpp.pistache.server.model
