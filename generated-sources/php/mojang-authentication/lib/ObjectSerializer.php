...
use com.github.asyncmc.mojang.authentication.php.server\com.github.asyncmc.mojang.authentication.php.model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\com.github.asyncmc.mojang.authentication.php.server\Model\\' . $data->{$discriminator};
