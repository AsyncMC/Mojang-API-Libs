...
use com.github.asyncmc.mojang.status.php.server\com.github.asyncmc.mojang.status.php.model\ModelInterface;
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\com.github.asyncmc.mojang.status.php.server\Model\\' . $data->{$discriminator};
