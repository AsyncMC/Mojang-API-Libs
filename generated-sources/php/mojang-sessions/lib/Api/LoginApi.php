...
class LoginApi
{
     ...
     * @return \OpenAPI\Client\Model\PlayerProfile|\OpenAPI\Client\Model\SessionApiError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\PlayerProfile|\OpenAPI\Client\Model\SessionApiError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPlayerProfileWithHttpInfo($stripped_uuid, $unsigned = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\PlayerProfile' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\PlayerProfile', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 400:
                    if ('\OpenAPI\Client\Model\SessionApiError' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = $responseBody->getContents();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\SessionApiError', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\OpenAPI\Client\Model\PlayerProfile';
            $responseBody = $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\PlayerProfile',
                ...
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\SessionApiError',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
